package es.salesianos.zaragoza.ciberhealth.web.rest;

import static es.salesianos.zaragoza.ciberhealth.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import es.salesianos.zaragoza.ciberhealth.CiberHealthFakeApp;
import es.salesianos.zaragoza.ciberhealth.config.Constants;
import es.salesianos.zaragoza.ciberhealth.domain.User;
import es.salesianos.zaragoza.ciberhealth.repository.AuthorityRepository;
import es.salesianos.zaragoza.ciberhealth.repository.UserRepository;
import es.salesianos.zaragoza.ciberhealth.security.AuthoritiesConstants;
import es.salesianos.zaragoza.ciberhealth.service.UserService;
import es.salesianos.zaragoza.ciberhealth.service.dto.PasswordChangeDTO;
import es.salesianos.zaragoza.ciberhealth.service.dto.UserDTO;
import es.salesianos.zaragoza.ciberhealth.web.rest.vm.KeyAndPasswordVM;
import es.salesianos.zaragoza.ciberhealth.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = CiberHealthFakeApp.class)
